        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    MyVideoPlayer.this.currentPlayer.prepare();
...
//                        try {
                        ...
                        MyVideoPlayer.this.nextPlayer.prepare();
    ...
    private void onVideoComplete(MediaPlayer mediaPlayer, final SurfaceHolder surfaceHolder){
        try{
            ...
            if(currentVideoIndex <= urlList.size()){
                MyVideoPlayer.this.nextPlayer.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
                    @Override
                    public void onPrepared(MediaPlayer mediaPlayer) {
                        loadNextSuccessListener.onLoaded();
                    }
                });
